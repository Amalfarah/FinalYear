package com.example.cs17aaf1.gbvreportapp;
...
public class MapsActivi extends FragmentActivity implements OnMapReadyCallback {
...
//        BottomNavigationView bottomNavigationView = (BottomNavigationView) findViewById(R.id.map);
//        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
//            @Override
//            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
//                switch (item.getItemId()) {
//                    case R.id.navigation_map:
//                        Toast.makeText(MapsActivi.this, "Location Search", Toast.LENGTH_SHORT).show();
//
//                        break;
//                    case R.id.navigation_form:
//                        Toast.makeText(MapsActivi.this, "Forms", Toast.LENGTH_SHORT).show();
//                        Intent intent =new Intent(MapsActivi.this,optionspage.class);
//                        startActivity(intent);
//                        finish();
//                        break;
//                    case R.id.navigation_hotline:
//                        Toast.makeText(MapsActivi.this, "Hotline", Toast.LENGTH_SHORT).show();
//                        break;
//                }
//                return false;
//            }
